    ...
    return (
        ...
        <>
            ...
            <div className="bg-white w-[100%] py-10 flex  items-center justify-center ">
                <div className="bg-[#FAFAFA] border-[1.5px] border-[#E5E7EB] rounded-[16px] overflow-hidden w-[84%]  flex md:flex-row flex-col items-center justify-between ">
                    <div className="md:w-[24.9%] w-[80%] md:py-[18px] py-[10px] flex md:flex-row flex-col  items-center justify-center gap-3 text-white ">
                        ...
                        <div className="flex flex-col md:text-start text-center ">
                            <p className="font-black text-[16.5px] text-[#111827] ">Free shipping</p>
                            <p className="text-[14px] text-[#4B5563] ">On Orders over $50.00</p>
                        </div>
                    </div>
                    ...
                    <div className="md:w-[24.9%] w-[80%] md:py-[18px] py-[10px] flex md:flex-row flex-col  items-center justify-center gap-3 text-white ">
                        ...
                        <div className="flex flex-col md:text-start text-center ">
                            <p className="font-black text-[16.5px] text-[#111827] ">Ver easy to return</p>
                            <p className="text-[14px] text-[#4B5563] ">Just phone number</p>
                        </div>
                    </div>
                    ...
                    <div className="md:w-[24.9%] w-[80%] md:py-[18px] py-[10px] flex md:flex-row flex-col  items-center justify-center gap-3 text-white ">
                        ...
                        <div className="flex flex-col md:text-start text-center ">
                            <p className="font-black text-[16.5px] text-[#111827] ">Worldwide delivery</p>
                            <p className="text-[14px] text-[#4B5563] ">Fast delivery worldwide</p>
                        </div>
                    </div>
                    ...
                    <div className="md:w-[24.9%] w-[80%] md:py-[18px] py-[10px] flex md:flex-row flex-col  items-center justify-center gap-3 text-white ">
                        ...
                        <div className="flex flex-col md:text-start text-center ">
                            <p className="font-black text-[16.5px] text-[#111827] ">Refunds policy</p>
                            <p className="text-[14px] text-[#4B5563] ">60 days return for any reason</p>
                        </div>
                    </div>
            ...
            <div className="w-[100%] py-[40px] px-[90px] flex flex-col gap-7 ">
                ...
                <div className="flex justify-between  w-[100%]   ">
                    <div className="border-[1.5px] bg-white w-[calc(97%/3)] p-[26px] flex justify-around items-center rounded-[15px] ">
                        <div className="">
                            <p className="text-[22px] font-extrabold ">Men & Women</p>
                            <p className="text-[12px] font-bold text-[#4B5563] ">Starting from $49.99</p>
                        </div>
                        <button className="flex items-center justify-center h-[fit-content] pl-[8px] p-[4.5px] text-[15px] gap-2  border-l-[2.8px] border-l-[#E5E7EB] font-bold text-[#4B5563]  ">Shop Now <GoArrowRight /></button>
                    </div>
                    <div className="border-[1.5px] bg-white w-[calc(97%/3)] p-[26px] flex justify-around items-center rounded-[15px] ">
                        <div className="">
                            <p className="text-[22px] font-extrabold ">For Kids</p>
                            <p className="text-[12px] font-bold text-[#4B5563] ">Starting from $30</p>
                        </div>
                        <button className="flex items-center justify-center h-[fit-content] pl-[8px] p-[4.5px] text-[15px] gap-2  border-l-[2.8px] border-l-[#E5E7EB] font-bold text-[#4B5563]  ">Shop Now <GoArrowRight /></button>
                    </div>
                    <div className="border-[1.5px] bg-white w-[calc(97%/3)] p-[26px] flex items-center justify-around rounded-[15px] ">
                        <div className="">
                            <p className="text-[22px] font-extrabold ">Accessories</p>
                            <p className="text-[12px] font-bold text-[#4B5563] ">Explore Accessories</p>
                        </div>
                        <button className="flex items-center justify-center h-[fit-content] pl-[8px] p-[4.5px] text-[15px] gap-2  border-l-[2.8px] border-l-[#E5E7EB] font-bold text-[#4B5563]  ">Shop Now <GoArrowRight /></button>
                    </div>
                </div>
