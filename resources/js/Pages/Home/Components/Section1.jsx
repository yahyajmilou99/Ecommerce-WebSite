        ...
        <>
            <section className="Section1">
                ...
                <div className="w-[100%] py-[40px] px-[20px] md:px-[25px] lg:px-[100px] flex flex-col md:justify-start justify-center gap-7 ">
                    <p className="text-[33px] flex font-bold">Start exploring. <span className="text-[#4B5563] md:block hidden">Good things are waiting for you</span></p>
                    <div className="flex md:flex-row flex-col justify-between  w-[100%] md:gap-0 gap-5   ">
                        <div className="border-[1.5px]  md:w-[calc(97%/3)] p-[10px] xl:p-[16px] flex justify-around items-center rounded-[15px] ">
                            <div className="">
                                <p className="2xl:text-[25px]  xl:text-[20px] lg:text-[16px] text-[16px] font-extrabold ">Men & Women</p>
                        ...
                        <div className="border-[1.5px]  md:w-[calc(97%/3)] p-[10px] xl:p-[16px] flex justify-around items-center rounded-[15px] ">
                            <div className="">
                                <p className="2xl:text-[25px] xl:text-[20px] lg:text-[16px] text-[16px] font-extrabold ">For Kids</p>
                        ...
                        <div className="border-[1.5px]  md:w-[calc(97%/3)] p-[10px] xl:p-[16px] flex items-center justify-around rounded-[15px] ">
                            <div className="">
                                <p className="2xl:text-[25px] xl:text-[20px] lg:text-[16px] text-[16px] font-extrabold ">Accessories</p>
